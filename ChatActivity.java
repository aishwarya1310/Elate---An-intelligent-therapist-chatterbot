...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setLogo(R.mipmap.elate);
    ...
    private void loadDummyHistory() {
        ...
        msg1.setId(2);
        msg1.setMe(false);
        msg1.setMessage("It seems you're pretty positive today!! ^_^");
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
              ...
              //      Toast.makeText(ChatActivity.this, "Response (message): " + msg, Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        Toast.makeText(ChatActivity.this, "Error: " + response.errorBody().string(), Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
