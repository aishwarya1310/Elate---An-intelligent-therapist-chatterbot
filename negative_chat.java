...
public class negative_chat extends AppCompatActivity {
    ...
    private void loadDummyHistory() {
        ...
        msg1.setId(2);
        msg1.setMe(false);
        msg1.setMessage("It seems you're feeling down!! ");
        msg1.setDate(DateFormat.getDateTimeInstance().format(new Date()));
        chatHistory.add(msg1);



        adapter = new ChatAdapter(negative_chat.this, new ArrayList<ChatMessage>());
    ...
    public String getSomething(String message) {
        ...
        api.getMessage(object).enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.code() == 200) {
                    ...
                    try {
                        ...
                        Toast.makeText(negative_chat.this, "Error: " + response.errorBody().string(), Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(negative_chat.this, "Failure: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
